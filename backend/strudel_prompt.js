// strudel_prompt.js - Shared system prompt used by every provider
// (backend/claude.js, backend/openrouter.js, ...). Keeping this in one
// place means a prompt fix benefits every provider automatically, instead
// of drifting across per-provider copies. Response cleanup/validation
// lives in backend/strudel_pipeline/ (see index.js's processStrudelCode).
